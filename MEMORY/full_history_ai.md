...
duration_min: 30
issue: 16
focus: tools_capture_demo_sh_drives_three_load_bearing_security_surfaces
delta:
  files_added: 3   # tools/capture_demo.sh, tools/check-capture-demo.mjs, tools/check-capture-demo.test.mjs
  files_changed: 2 # README.md (Demo section rewrite), .github/workflows/ci.yml (+capture-demo job)
  tests_added: 9   # node:test unit tests for the asserter
  contract_clauses_pinned: 5
context_for_next_session:
  - third_acceptance_bullet_satisfied_first_two_remain_jt_recording_step_so_pr_stays_draft_until_gif_lands
  - script_runs_three_surfaces_each_exercising_load_bearing_primitive_d_004_sql_guard_d_005_d_006_path_resolution_d_007_token_redaction
  - surface_1_no_db_required_uses_sqlguard_directly_via_tsx_e_in_postgres_readonly_server
  - surface_2_real_disk_io_under_tempfile_temporarydirectory_so_symlink_follow_check_exercises_realpath_the_way_the_server_does
  - surface_3_injects_fake_fetch_returning_fixture_gist_with_150kb_file_for_truncation_cap_then_401_with_token_sentinel_for_redaction_assertion
  - fakefetch_verifies_token_is_on_authorization_header_d_007_contract_is_on_the_wire_never_in_error_context
  - check_capture_demo_mjs_pure_helpers_exported_required_patterns_forbidden_literals_assert_capture_output_run_capture_demo_so_unit_tests_drive_synthetic_input
  - cross_file_invariant_test_reads_capture_demo_sh_as_text_and_asserts_token_sentinel_literal_matches_asserter_constant_so_changing_one_but_not_other_cant_silently_make_check_no_op
  - ci_capture_demo_job_installs_node_20_python_3_11_npm_ci_in_two_servers_pip_install_e_one_server_then_runs_checker_plus_its_own_unit_tests
  - tamper_verified_two_axes_drop_required_pattern_fires_missing_required_with_dropped_name_append_token_sentinel_fires_forbidden_present_with_d_007_named
  - twelfth_post_v0_1_drift_or_demo_capture_addition_in_portfolio_pattern_fourth_capture_script_after_llm_eval_harness_llm_cost_optimizer_prompt_regression_suite_rag_production_kit
  - mcp_cookbook_now_has_capture_script_under_tools_unlike_other_repos_which_use_scripts_consistent_with_repo_convention_check_readme_check_spec_version_check_architecture_doc_check_capture_demo_all_in_tools
  - existing_check_readme_check_architecture_doc_check_spec_version_all_unchanged_green_per_server_test_suites_unchanged_41_31_60_20_23
decisions_made: []
followups: []
---
