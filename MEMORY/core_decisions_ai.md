...
- id: D-010
  date: 2026-08-25
  decision: the_filesystem_sandbox_refusal_string_is_a_client_visible_contract_identical_in_both_ports_with_a_json_quoted_path
  rationale: the_py_readme_calls_itself_A_LINE_FOR_LINE_PORT_same_threat_model_same_tools_and_the_two_ports_shared_FOUR_parity_tables_max_bytes_grammar_98_value_domain_137_config_trim_139_and_resolve_141_EVERY_ONE_OF_WHICH_COVERS_AN_INTERNAL_the_string_a_client_reads_when_a_call_is_REFUSED_had_never_been_compared_and_ALL_FOUR_ARMS_DIVERGED_prefix_sandbox_refusal_vs_sandbox_escape_python_REPEATED_THE_REASON_because_SandboxEscape_init_already_puts_reason_colon_input_repr_in_the_message_python_repr_quoted_the_path_while_ts_emitted_it_raw_and_python_prefixed_a_generic_error_with_value_error_where_ts_used_no_label
  chosen_spelling: "sandbox_escape (<reason>): <json-quoted input>"
  quoting: json_dumps_ensure_ascii_false_and_JSON_stringify_MEASURED_to_agree_on_8_of_9_awkward_codepoints_u2028_u2029_u0085_u00a0_nul_u001f_u007f_lone_surrogate_ufeff_the_ninth_is_a_LONE_SURROGATE_which_python_cannot_encode_to_utf8_and_so_cannot_reach_its_port_at_all
  alternatives_rejected: [keep_sandbox_refusal_REJECTED_sandbox_escape_is_the_typed_SandboxEscapeReason_vocabulary_where_sandbox_refusal_is_prose, leave_the_input_unquoted_REJECTED_a_path_with_a_space_a_trailing_separator_or_a_nul_is_AMBIGUOUS_in_a_refusal_message_and_ambiguity_is_exactly_what_a_sandbox_refusal_must_not_have, keep_pythons_value_error_prefix_and_add_a_ts_counterpart_REJECTED_both_ports_raise_the_SAME_MESSAGE_TEXT_at_the_two_corresponding_sites_so_dropping_the_prefix_makes_them_identical_rather_than_inventing_a_label, fix_only_python_REJECTED_two_of_the_four_axes_are_ts_side_choices_so_a_one_sided_fix_would_be_picking_ts_as_correct_by_default_rather_than_by_argument]
  both_ports_changed: true
  related_issues: [#148]
  superseded_by: null
