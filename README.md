...
cd servers/internal-tools-bridge  && npm install && npm test    # 42 bridge + tool + public-surface + repo-stats-readme-lock + timeoutMs setTimeout-clamp upper bound tests (no shell, env scrub, output cap, wall-clock-bound timeout, validateConfig)
