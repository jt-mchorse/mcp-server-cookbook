...
```bash
cd servers/postgres-readonly      && npm install && npm test    # 77 SQL-guard (+ SELECT-INTO, comment-merged-keyword & backslash-quote-split guards) + public-surface + cfg-validation tests
